        ...
        <div class="tw-bg-white tw-p-4">
          ...
          >
            ...
            <div class="tw-col-span-2 md:tw-col-span-1">
              ...
              <div class="tw-relative">
                ...
                >
                  ...
                  <option :value="itemCopy.city" disabled>
                    {{ itemCopy.city }}
                  </option>
                  <option v-for="c in cities" :value="c.name" :key="c.id">
                    {{ c.name }}
                  </option>
                </select>
                <div
            ...
            <div class="tw-col-span-2">
              ...
              <div class="tw-relative">
                ...
                >
                  <option
                    :value="c.value"
                    :class="[c.text, !c.value && '!tw-text-green-500']"
            ...
            <div
              ...
              v-if="itemCopy.confirmation == 'reporter'"
            >
              <label
                class="tw-block tw-mb-2 tw-text-sm tw-font-medium tw-text-gray-900 dark:tw-text-white"
                >Reported Date</label
            ...
            <div class="md:tw-col-span-1 tw-col-span-2">
              <OrderAffectation
                :item="itemCopy"
                v-model:error="errors.affectation"
                v-model:affectation="itemCopy.affectation"
              />
            </div>
            ...
            <div class="tw-col-span-2">
              <label
                class="tw-block tw-mb-2 tw-text-sm tw-font-medium tw-text-gray-900"
                >Order Items
                <span v-if="errors.items" class="tw-text-red-400 tw-text-xs">
                  # {{ errors.items }}</span
                ></label
              >
              <div>
                <OrderItems
                  ...
                  :error="errors.items"
                  :products="products"
                  :products-fetched="products_fetched"
                  v-model:items="itemCopy.items"
                />
              </div>
            </div>
              ...
              <button @click="showProducts = !showProducts" class="tw-bg-whites tw-shadow-sm tw-px-2 tw-py-1 tw-my-5 tw-w-[150px] tw-h-[30px] tw-border tw-border-solid tw-border-emerald-500/20 hover:tw-bg-emerald-500/10 hover:tw-border-emerald-500/70 tw-duration-300 tw-text-emerald-500/80 tw-rounded-md tw-flex tw-items-center tw-justify-center">
                    ...
                    <div v-if="showProducts">
                      <div v-if="paginatedProducts.length > 0">
                        ...
                        <thead>
                          <tr>
                            <th class="tw-border tw-px-4 tw-py-2 tw-w-[150px] tw-flex-wrap">Product Name</th>
                            <th class="tw-border tw-px-4 tw-py-2 tw-w-[150px] tw-flex-wrap">Link video</th>
                            <th class="tw-border tw-px-4 tw-py-2 tw-w-[150px] tw-flex-wrap">Link Store</th>
                          </tr>
                        </thead>
                        <tbody>
