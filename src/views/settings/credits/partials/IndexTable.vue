                ...
                <div class="tw-overflow-hidden tw-border tw-border-gray-200 darkx:tw-border-gray-700 md:tw-rounded-lg">
                    <table class="tw-min-w-full tw-divide-y tw-divide-gray-200 darkx:tw-divide-gray-700">
                        ...
                        <tbody v-if="!loading && items.length > 0" class="tw-bg-white tw-divide-y tw-divide-gray-200 darkx:tw-divide-gray-700 darkx:tw-bg-gray-900">
                          <TableRow @delete="handleDelete" @update="newItem => $emit('update', newItem)" v-for="item in items" :key="item.id" :item="item" />
                        </tbody>
...
<script>
import TablePaginationNoNums from '@/views/settings/credits/partials/table/TablePaginationNoNums';
import TableRow from '@/views/settings/credits/partials/table/TableRow';
...
export default {
  ...
  methods: {
    handleDelete(deletedItem) {
      this.$emit('delete-item', deletedItem);
    }
  }
  // mounted(){
