<template>
  <div class="md:tw-col-span-3 tw-col-span-12 tw-rounded">
    <label
      ...
      >Product</label
    >
    <vue-select append-to-body :reduce="(o) => o.id" @option:selected="e=> $emit('update', {...filters, product_id: e.id})" :clearable="false" class="tw-bg-gray-50 tw-border-solid tw-outline-none  tw-text-gray-900 tw-text-sm tw-rounded-lg focus:tw-ring-orange-500 focus:tw-border-orange-500 tw-block tw-w-full custom-vue-select"
