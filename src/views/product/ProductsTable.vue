                ...
                <tr v-for="product in products" :key="product.id" class="tw-bg-white tw-border-b tw-whitespace-nowrap hover:tw-bg-gray-50">
                    <td class="tw-w-4 tw-p-4">
                        <div class="tw-flex tw-items-center">
                            ...
                            <span v-if="product.status == 1" class="tw-w-2.5 tw-h-2.5 tw-rounded-full tw-bg-green-500"></span>
                            <span v-if="product.status == 0" class="tw-w-2.5 tw-h-2.5 tw-rounded-full tw-bg-yellow-500"></span>
                        </div>
                    </td>
