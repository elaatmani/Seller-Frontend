...
<script>
import IndexStatistics from '@/views/seller/partials/filters/IndexStatistics'
import IndexExport from '@/views/seller/partials/filters/IndexExport'
import FiltersWrapper from '@/views/seller/partials/filters/FiltersWrapper'
