      ...
      >
        ...
        <div class="tw-bg-white tw-p-4">
            <div class="tw-grid tw-gap-6 tw-gap-y-5 tw-grid-cols-1 md:tw-grid-cols-2">
              ...
              <div class="md:tw-col-span-1 tw-col-span-2" v-if="itemCopy.confirmation == 'reporter' && false">
                <label
                  class="tw-block tw-mb-2 tw-text-sm tw-font-medium tw-text-gray-900 dark:tw-text-white"
                  >Reported Date</label
                >
...
import OrderItems from '@/views/seller/partials/components/OrderItems'
import OrderAffectation from '@/views/seller/partials/components/OrderAffectation'
