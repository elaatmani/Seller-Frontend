    ...
    <div>
      ...
      <tbody v-else>
        <template v-if="items.length > 0">
            <tr v-for="item in items" :key="item" class="tw-border-b tw-border-solid tw-border-gray-100 last:tw-border-b-0 tw-group even:tw-bg-gray-50/50 hover:tw-bg-primary-50/60 tw-duration-100">
...
const columns = ref([
  ...
  { name: 'orders', label: 'Orders', classes: [ 'tw-w-[100px]' ] },
  { name: 'quantity', label: 'Quantity', classes: [ 'tw-w-[100px]' ] },
